...
// Write key to file
	...
	wcout << L"Total encryption time in 10000 running times: " << etime[0] << " ms" << endl;
	wcout << L"Average encryption time: " << etime[0] / N_ITER << " ms" << endl;

	wcout << endl;

	wcout << L"Total Decryption time in 10000 running times: " << etime[1] << " ms" << endl;
	wcout << L"Average decryption time : " << etime[1] / N_ITER << " ms" << endl;
